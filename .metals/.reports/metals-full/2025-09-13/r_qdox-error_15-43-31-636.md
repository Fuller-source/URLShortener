error id: file://<WORKSPACE>/src/main/java/com/example/urlshortener/UrlShortenerApplication.java
file://<WORKSPACE>/src/main/java/com/example/urlshortener/UrlShortenerApplication.java
...
```java
offset: 0
uri: file://<WORKSPACE>/src/main/java/com/example/urlshortener/UrlShortenerApplication.java
text:
```scala
@@
```
...
QDox parse error in file://<WORKSPACE>/src/main/java/com/example/urlshortener/UrlShortenerApplication.java