error id: file://<WORKSPACE>/src/main/java/com/example/urlshortener/service/UrlService.java
file://<WORKSPACE>/src/main/java/com/example/urlshortener/service/UrlService.java
...
```java
offset: 0
uri: file://<WORKSPACE>/src/main/java/com/example/urlshortener/service/UrlService.java
text:
```scala
@@
```
...
QDox parse error in file://<WORKSPACE>/src/main/java/com/example/urlshortener/service/UrlService.java