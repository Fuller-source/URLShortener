error id: file://<WORKSPACE>/src/main/java/com/example/urlshortener/model/UrlMapping.java
file://<WORKSPACE>/src/main/java/com/example/urlshortener/model/UrlMapping.java
...
```java
offset: 0
uri: file://<WORKSPACE>/src/main/java/com/example/urlshortener/model/UrlMapping.java
text:
```scala
@@
```
...
QDox parse error in file://<WORKSPACE>/src/main/java/com/example/urlshortener/model/UrlMapping.java