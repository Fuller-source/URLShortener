error id: file://<WORKSPACE>/src/main/java/com/example/urlshortener/repository/UrlRepository.java
file://<WORKSPACE>/src/main/java/com/example/urlshortener/repository/UrlRepository.java
...
```java
offset: 0
uri: file://<WORKSPACE>/src/main/java/com/example/urlshortener/repository/UrlRepository.java
text:
```scala
@@
```
...
QDox parse error in file://<WORKSPACE>/src/main/java/com/example/urlshortener/repository/UrlRepository.java